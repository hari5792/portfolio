...
// Dictionary of Sector Leaders for Live API Market Scanning
const SECTOR_LEADER_DIRECTORY = {
  ...
  'Infrastructure & Capex': [
    ...
    { symbol: 'PNCINFRA', name: 'PNC Infratech Ltd', horizonTag: 'Short-Term', potential: '15% - 22% Upside', rationale: 'High-ROE highway and water supply infrastructure EPC player with steady execution.', tags: ['High ROE', 'Highways', 'EPC Execution'] }
  ],
  'Power & Renewable Energy': [
    ...
    { symbol: 'TATAPOWER', name: 'Tata Power Co Ltd', horizonTag: 'Short-Term', potential: '16% - 23% Upside', rationale: 'Integrated power utility expanding renewable EV charging grid and solar rooftop manufacturing.', tags: ['EV Grid', 'Solar Rooftops', 'Renewables'] }
  ],
  ...
  'Pharma & Healthcare': [
    ...
    { symbol: 'CIPLA', name: 'Cipla Ltd', horizonTag: 'Long-Term', potential: '13% - 16% CAGR', rationale: 'Respiratory medicine market leader with expanding US generic and domestic consumer health business.', tags: ['Respiratory Leader', 'Chronic Care', 'Defensive'] }
  ],
  'IT & Software': [
    { symbol: 'TCS', name: 'Tata Consultancy Services Ltd', horizonTag: 'Long-Term', potential: '13% - 16% CAGR', rationale: 'Global IT services giant benefiting from cloud migration and generative AI transformation deals.', tags: ['IT Leader', 'High ROE', 'Dividend Yield'] }
  ]
};
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // 1. Identify User's Current & Missing Sectors
    ...
    // 2. Dynamically Select Candidate Leaders for Missing Sectors
    const candidateList = [];
    ...
    // 3. Fetch Live Market Prices from NSE API for candidate stocks
    ...
    // 4. In-Portfolio Average Down Calculations
    ...
    return res.status(500).json({ error: 'Recommendation API Error: ' + err.message });
  }
};
